  ...
  const SelectionScreen = () => (
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-base-content">Talep Oluştur</h1>
        <p className="text-base-content/70 mt-2">Lütfen oluşturmak istediğiniz talep türünü seçiniz.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl px-4">
        ...
        <div 
          ...
          className="group relative bg-base-100 p-8 rounded-2xl shadow-md border-2 border-transparent hover:border-info hover:shadow-xl cursor-pointer transition-all duration-300 flex flex-col items-center text-center"
        >
        ...
        <div 
          ...
          className="group relative bg-base-100 p-8 rounded-2xl shadow-md border-2 border-transparent hover:border-warning hover:shadow-xl cursor-pointer transition-all duration-300 flex flex-col items-center text-center"
        >
    ...
    <div className="p-6">
      ...
      {activeTab !== 'selection' && (
        <button 
          ...
          className="mb-6 flex items-center text-base-content/60 hover:text-info transition-colors font-medium"
        >
