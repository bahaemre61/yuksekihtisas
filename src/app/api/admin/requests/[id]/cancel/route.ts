...
export async function PUT(
  ...
  try {
    ...
    if (requestDoc.status === RequestStatus.COMPLETED || requestDoc.status === RequestStatus.CANCELLED) {
    ...
    return NextResponse.json({ success: true, msg: 'Talep başarıyla iptal edildi.' }, { status: 200 });
